...
| [产品设计文档](../references/产品设计.md) | v1.1 | ✅ 已完成 | 2026-03-22 | References |
...
- [产品设计文档 §6.1](../references/产品设计.md#6-产品方案) - 产品架构
...
- [产品设计文档 §6.2](../references/产品设计.md#62-vibe-coding-核心机制) - 核心机制
...
- [产品设计文档 §7](../references/产品设计.md#7-交互设计) - 交互设计
...
**数据埋点**: 详见 [产品设计文档 §8](../references/产品设计.md#8-数据埋点)
...
### 内部文档
- [`../references/产品设计.md`](../references/产品设计.md) - 完整产品需求和市场定位
- [`../references/架构设计.md`](../references/架构设计.md) - 技术架构和系统设计
- [`../references/symphony.md`](../references/symphony.md) - AI 编码代理编排参考
