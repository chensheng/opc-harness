...
# Usage: .\.harness\scripts\harness-gc.ps1
...
$docDirs = @(
    ".harness/context-engineering/execution-logs",
    ".harness/context-engineering/decision-records"
)
...
Write-Host "  2. Use 'npm run harness:check' to verify architecture health" -ForegroundColor Gray
